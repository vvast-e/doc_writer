...
class App(ctk.CTk):
    def __init__(self) -> None:
        ...
        self.manual_textbox.insert(
            "1.0", "привет это тест ввода текста скриптом, под видом человека"
        )
        self.user_data_entry.insert(0, "D:/doc_writer/chrome-profile1/Profile 1")
        self.chrome_exe_entry.insert(
